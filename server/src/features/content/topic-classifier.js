...
const KEYWORD_RULES = [
  ...
  // Rotational Motion
  { subject: 'Physics', chapter: 'Rotational Motion', topic: 'Torque and Equilibrium', keywords: ['thin rod mn, free to rotate in the vertical plane', 'thin rod mn', 'held horizontal. when the end m is released', 'moment of the force', 'torque', 'uniform rod suspended', 'pivoted rod', 'hinged rod', 'rotational equilibrium', 'suspended from', 'angular acceleration'] },
  ...
  { subject: 'Physics', chapter: 'Thermal Properties of Matter', topic: 'Calorimetry and Heat Transfer', keywords: ['temperature difference', 'steady state', 'thermal resistance', 'rate of heat flow', 'thermal conductivity', 'conduction', 'cross-section as ab', 'bent rod', 'rod ab of length', 'heat flow', 'conduction of heat', 'convection', 'radiation', 'calorimeter', 'calorimetry', 'water equivalent', 'latent heat', 'specific heat capacity', 'black body', 'wien', 'stefan'] },
  { subject: 'Physics', chapter: 'Thermal Properties of Matter', topic: 'Heat, Temperature and Thermal Expansion', keywords: ['thermal expansion', 'coefficient of linear expansion', 'coefficient of volume expansion', 'bimetallic strip', 'linear expansion', 'superficial expansion', 'expansion of liquids', 'thermal stress'] },
  { subject: 'Physics', chapter: 'Thermal Properties of Matter', topic: "Newton's Law of Cooling", keywords: ['body takes 10 minutes to cool from 60', 'temperature of surroundings is constant at 25', "newton's law of cooling", 'rate of cooling', 'temperature of surroundings'] },
  { subject: 'Physics', chapter: 'Thermodynamics', topic: 'Second Law, Heat Engines and Carnot Cycle', keywords: ['carnot engines a and b', 'carnot engine', 'reservoir at 600 k', 'thermal efficiency', 'carnot cycle', 'coefficient of performance', 'heat engine'] },
  { subject: 'Physics', chapter: 'Thermodynamics', topic: 'First Law of Thermodynamics', keywords: ['two moles of an ideal monoatomic gas', 'pv diagram', 'monoatomic gas', 'path abca', 'maximum temperature', 'heat absorbed', 'cyclic process', 'work done by gas', 'first law of thermodynamics', 'isothermal', 'adiabatic', 'isobaric', 'isochoric'] },
  { subject: 'Physics', chapter: 'Kinetic Theory of Gases', topic: 'Degrees of Freedom and Specific Heat', keywords: ['degrees of freedom', 'molar specific heat', 'cv', 'cp', 'cp/cv', 'ratio of specific heats', 'gamma ='] },
  { subject: 'Physics', chapter: 'Kinetic Theory of Gases', topic: 'Kinetic Theory and RMS Speed', keywords: ['thermal velocity of a helium atom', 'root mean square', 'v_rms', 'kinetic theory', 'boltzmann', 'most probable speed', 'average speed'] },
