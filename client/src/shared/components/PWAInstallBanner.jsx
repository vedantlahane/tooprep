...
export default function PWAInstallBanner() {
  ...
  if (isOffline) {
    return (
      <div className="bg-status-weak/15 border-b border-status-weak/30 px-4 py-2 text-center text-xs font-mono text-status-weak flex items-center justify-center gap-2 animate-fade-in z-50">
        <span className="w-2 h-2 rounded-full bg-status-weak animate-ping"></span>
    ...
    return (
      <div className="bg-neutral-900 border-b border-primary/30 px-4 py-2.5 text-xs font-mono flex items-center justify-between gap-3 animate-fade-in z-50">
        <div className="flex items-center gap-2 text-white">
          <div className="w-5 h-5 rounded-xs bg-primary/20 border border-primary/40 flex items-center justify-center text-primary text-[10px] font-bold">
